...
public class MainActivity extends AppCompatActivity {
    ...
    public int checkValue(String s){
        ...
        while(s.length()!=0){
            ...
            else if(s.substring(0,1).equals("j")||s.substring(0,1).equals("x")){
                val+= 8;
            }
            else if(s.substring(0,1).equals("k")){
                val+= 5;
            }
            else if(s.substring(0,1).equals("f")||s.substring(0,1).equals("h")||s.substring(0,1).equals("v")||s.substring(0,1).equals("w")||s.substring(0,1).equals("y")){
                val+= 4;
            }
            else if(s.substring(0,1).equals("b")||s.substring(0,1).equals("c")||s.substring(0,1).equals("m")||s.substring(0,1).equals("p")){
                val+= 3;
            }
            else if(s.substring(0,1).equals("d")||s.substring(0,1).equals("g")){
                val+= 2;
            }
            else {
                val += 1;
